...
contract YEARNYFINETWORK {
    ...
    constructor() public {
        ...
        treasury = address(0xD982633b51b5b255d261fd222f269ac9fC9313B9);

        // Set your total token supply (default 18000)
        totalSupply = 18000 * 10**uint(decimals);
